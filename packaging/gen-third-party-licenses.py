...
def main():
    ...
    lines.append("")
    lines.append("TrailMate's **release builds** (the `.dmg`) bundle Sparkle, a CPython runtime,")
    lines.append("and a set of Python libraries inside the app. This file inventories every")
    lines.append("bundled component and its license. Python package license text travels in the")
    lines.append("app bundle's `*.dist-info/` metadata under")
    lines.append("`Contents/Resources/PythonResources/python-libs/`; Sparkle's full notice is")
    lines.append("published upstream with the exact pinned source package.")
    lines.append("")
    ...
    lines.append("")
    lines.append("## Native framework")
    lines.append("")
    lines.append("| Component | Version | License |")
    lines.append("|-----------|---------|---------|")
    lines.append("| Sparkle | 2.9.6 | MIT with bundled permissive notices |")
    lines.append("")
