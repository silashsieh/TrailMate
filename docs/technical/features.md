...
- v2.1.3 is the corrected bootstrap updater build. Its full update path to stable v2.2.0—feed discovery, download, signature verification, installation, and relaunch—was validated successfully on 2026-09-03. The public v2.1.2 pre-release requires one manual replacement because its updater configuration cannot start safely.
